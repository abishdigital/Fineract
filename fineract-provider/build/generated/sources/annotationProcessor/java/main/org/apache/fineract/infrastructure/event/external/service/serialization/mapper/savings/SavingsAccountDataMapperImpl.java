...
import org.apache.fineract.avro.savings.v1.SavingsAccountSubStatusEnumDataV1;
...
@Component
public class SavingsAccountDataMapperImpl implements SavingsAccountDataMapper {
    ...
    @Autowired
    public SavingsAccountDataMapperImpl(AvroDateTimeMapper avroDateTimeMapper, AvroMonthDayMapper avroMonthDayMapper, ExternalIdMapper externalIdMapper) {
    ...
    @Override
    public SavingsAccountDataV1 map(SavingsAccountData source) {
        if ( source == null ) {
            return null;
        }

        SavingsAccountDataV1 savingsAccountDataV1 = new SavingsAccountDataV1();

        if ( source.getId() != null ) {
            savingsAccountDataV1.setId( source.getId().intValue() );
        }
        savingsAccountDataV1.setAccountNo( source.getAccountNo() );
        savingsAccountDataV1.setDepositType( enumOptionDataToEnumOptionDataV1( source.getDepositType() ) );
        savingsAccountDataV1.setExternalId( source.getExternalId() );
        if ( source.getGroupId() != null ) {
            savingsAccountDataV1.setGroupId( source.getGroupId().intValue() );
        }
        savingsAccountDataV1.setGroupName( source.getGroupName() );
        if ( source.getClientId() != null ) {
            savingsAccountDataV1.setClientId( source.getClientId().intValue() );
        }
        savingsAccountDataV1.setClientName( source.getClientName() );
        if ( source.getSavingsProductId() != null ) {
            savingsAccountDataV1.setSavingsProductId( source.getSavingsProductId().intValue() );
        }
        savingsAccountDataV1.setSavingsProductName( source.getSavingsProductName() );
        if ( source.getFieldOfficerId() != null ) {
            savingsAccountDataV1.setFieldOfficerId( source.getFieldOfficerId().intValue() );
        }
        savingsAccountDataV1.setFieldOfficerName( source.getFieldOfficerName() );
        savingsAccountDataV1.setStatus( savingsAccountStatusEnumDataToSavingsAccountStatusEnumDataV1( source.getStatus() ) );
        savingsAccountDataV1.setSubStatus( savingsAccountSubStatusEnumDataToSavingsAccountSubStatusEnumDataV1( source.getSubStatus() ) );
        savingsAccountDataV1.setReasonForBlock( source.getReasonForBlock() );
        savingsAccountDataV1.setTimeline( savingsAccountApplicationTimelineDataToSavingsAccountApplicationTimelineDataV1( source.getTimeline() ) );
        savingsAccountDataV1.setCurrency( currencyDataToCurrencyDataV1( source.getCurrency() ) );
        savingsAccountDataV1.setNominalAnnualInterestRate( source.getNominalAnnualInterestRate() );
        savingsAccountDataV1.setInterestCompoundingPeriodType( enumOptionDataToEnumOptionDataV1( source.getInterestCompoundingPeriodType() ) );
        savingsAccountDataV1.setInterestPostingPeriodType( enumOptionDataToEnumOptionDataV1( source.getInterestPostingPeriodType() ) );
        savingsAccountDataV1.setInterestCalculationType( enumOptionDataToEnumOptionDataV1( source.getInterestCalculationType() ) );
        savingsAccountDataV1.setInterestCalculationDaysInYearType( enumOptionDataToEnumOptionDataV1( source.getInterestCalculationDaysInYearType() ) );
        savingsAccountDataV1.setMinRequiredOpeningBalance( source.getMinRequiredOpeningBalance() );
        savingsAccountDataV1.setLockinPeriodFrequency( source.getLockinPeriodFrequency() );
        savingsAccountDataV1.setLockinPeriodFrequencyType( enumOptionDataToEnumOptionDataV1( source.getLockinPeriodFrequencyType() ) );
        savingsAccountDataV1.setWithdrawalFeeForTransfers( source.isWithdrawalFeeForTransfers() );
        savingsAccountDataV1.setAllowOverdraft( source.isAllowOverdraft() );
        savingsAccountDataV1.setOverdraftLimit( source.getOverdraftLimit() );
        savingsAccountDataV1.setMinRequiredBalance( source.getMinRequiredBalance() );
        savingsAccountDataV1.setEnforceMinRequiredBalance( source.isEnforceMinRequiredBalance() );
        savingsAccountDataV1.setMaxAllowedLienLimit( source.getMaxAllowedLienLimit() );
        savingsAccountDataV1.setLienAllowed( source.isLienAllowed() );
        savingsAccountDataV1.setMinBalanceForInterestCalculation( source.getMinBalanceForInterestCalculation() );
        savingsAccountDataV1.setOnHoldFunds( source.getOnHoldFunds() );
        savingsAccountDataV1.setWithHoldTax( source.isWithHoldTax() );
        savingsAccountDataV1.setLastActiveTransactionDate( avroDateTimeMapper.mapLocalDate( source.getLastActiveTransactionDate() ) );
        savingsAccountDataV1.setIsDormancyTrackingActive( source.isIsDormancyTrackingActive() );
        savingsAccountDataV1.setDaysToInactive( source.getDaysToInactive() );
        savingsAccountDataV1.setDaysToDormancy( source.getDaysToDormancy() );
        savingsAccountDataV1.setDaysToEscheat( source.getDaysToEscheat() );
        savingsAccountDataV1.setSavingsAmountOnHold( source.getSavingsAmountOnHold() );
        savingsAccountDataV1.setSummary( savingsAccountSummaryDataToSavingsAccountSummaryDataV1( source.getSummary() ) );
        savingsAccountDataV1.setTransactions( savingsAccountTransactionDataCollectionToSavingsAccountTransactionDataV1List( source.getTransactions() ) );
        savingsAccountDataV1.setCharges( savingsAccountChargeDataCollectionToSavingsAccountChargeDataV1List( source.getCharges() ) );
        savingsAccountDataV1.setWithdrawalFee( savingsAccountChargeDataToSavingsAccountChargeDataV1( source.getWithdrawalFee() ) );
        savingsAccountDataV1.setAnnualFee( savingsAccountChargeDataToSavingsAccountChargeDataV1( source.getAnnualFee() ) );
        savingsAccountDataV1.setNominalAnnualInterestRateOverdraft( source.getNominalAnnualInterestRateOverdraft() );
        savingsAccountDataV1.setMinOverdraftForInterestCalculation( source.getMinOverdraftForInterestCalculation() );

        return savingsAccountDataV1;
    }
    ...
    protected SavingsAccountSubStatusEnumDataV1 savingsAccountSubStatusEnumDataToSavingsAccountSubStatusEnumDataV1(SavingsAccountSubStatusEnumData savingsAccountSubStatusEnumData) {
        if ( savingsAccountSubStatusEnumData == null ) {
            return null;
        }

        SavingsAccountSubStatusEnumDataV1 savingsAccountSubStatusEnumDataV1 = new SavingsAccountSubStatusEnumDataV1();

        if ( savingsAccountSubStatusEnumData.getId() != null ) {
            savingsAccountSubStatusEnumDataV1.setId( savingsAccountSubStatusEnumData.getId().intValue() );
        }
        savingsAccountSubStatusEnumDataV1.setCode( savingsAccountSubStatusEnumData.getCode() );
        savingsAccountSubStatusEnumDataV1.setValue( savingsAccountSubStatusEnumData.getValue() );
        savingsAccountSubStatusEnumDataV1.setNone( savingsAccountSubStatusEnumData.isNone() );
        savingsAccountSubStatusEnumDataV1.setInactive( savingsAccountSubStatusEnumData.isInactive() );
        savingsAccountSubStatusEnumDataV1.setDormant( savingsAccountSubStatusEnumData.isDormant() );
        savingsAccountSubStatusEnumDataV1.setEscheat( savingsAccountSubStatusEnumData.isEscheat() );
        savingsAccountSubStatusEnumDataV1.setBlock( savingsAccountSubStatusEnumData.isBlock() );
        savingsAccountSubStatusEnumDataV1.setBlockCredit( savingsAccountSubStatusEnumData.isBlockCredit() );
        savingsAccountSubStatusEnumDataV1.setBlockDebit( savingsAccountSubStatusEnumData.isBlockDebit() );

        return savingsAccountSubStatusEnumDataV1;
    }
