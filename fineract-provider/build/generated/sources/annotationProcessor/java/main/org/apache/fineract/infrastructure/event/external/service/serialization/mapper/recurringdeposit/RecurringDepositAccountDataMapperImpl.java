...
@Component
public class RecurringDepositAccountDataMapperImpl implements RecurringDepositAccountDataMapper {
    ...
    @Autowired
    public RecurringDepositAccountDataMapperImpl(AvroDateTimeMapper avroDateTimeMapper, AvroMonthDayMapper avroMonthDayMapper, ExternalIdMapper externalIdMapper) {
    ...
    @Override
    public RecurringDepositAccountDataV1 map(RecurringDepositAccountData source) {
        if ( source == null ) {
            return null;
        }

        RecurringDepositAccountDataV1 recurringDepositAccountDataV1 = new RecurringDepositAccountDataV1();

        if ( source.getId() != null ) {
            recurringDepositAccountDataV1.setId( source.getId().intValue() );
        }
        recurringDepositAccountDataV1.setAccountNo( source.getAccountNo() );
        recurringDepositAccountDataV1.setExternalId( source.getExternalId() );
        if ( source.getGroupId() != null ) {
            recurringDepositAccountDataV1.setGroupId( source.getGroupId().intValue() );
        }
        recurringDepositAccountDataV1.setGroupName( source.getGroupName() );
        if ( source.getClientId() != null ) {
            recurringDepositAccountDataV1.setClientId( source.getClientId().intValue() );
        }
        recurringDepositAccountDataV1.setClientName( source.getClientName() );
        if ( source.getDepositProductId() != null ) {
            recurringDepositAccountDataV1.setDepositProductId( source.getDepositProductId().intValue() );
        }
        recurringDepositAccountDataV1.setDepositProductName( source.getDepositProductName() );
        if ( source.getFieldOfficerId() != null ) {
            recurringDepositAccountDataV1.setFieldOfficerId( source.getFieldOfficerId().intValue() );
        }
        recurringDepositAccountDataV1.setFieldOfficerName( source.getFieldOfficerName() );
        recurringDepositAccountDataV1.setStatus( savingsAccountStatusEnumDataToSavingsAccountStatusEnumDataV1( source.getStatus() ) );
        recurringDepositAccountDataV1.setTimeline( savingsAccountApplicationTimelineDataToSavingsAccountApplicationTimelineDataV1( source.getTimeline() ) );
        recurringDepositAccountDataV1.setCurrency( currencyDataToCurrencyDataV1( source.getCurrency() ) );
        recurringDepositAccountDataV1.setNominalAnnualInterestRate( source.getNominalAnnualInterestRate() );
        recurringDepositAccountDataV1.setInterestCompoundingPeriodType( enumOptionDataToEnumOptionDataV1( source.getInterestCompoundingPeriodType() ) );
        recurringDepositAccountDataV1.setInterestPostingPeriodType( enumOptionDataToEnumOptionDataV1( source.getInterestPostingPeriodType() ) );
        recurringDepositAccountDataV1.setInterestCalculationType( enumOptionDataToEnumOptionDataV1( source.getInterestCalculationType() ) );
        recurringDepositAccountDataV1.setInterestCalculationDaysInYearType( enumOptionDataToEnumOptionDataV1( source.getInterestCalculationDaysInYearType() ) );
        recurringDepositAccountDataV1.setMinRequiredOpeningBalance( source.getMinRequiredOpeningBalance() );
        recurringDepositAccountDataV1.setLockinPeriodFrequency( source.getLockinPeriodFrequency() );
        recurringDepositAccountDataV1.setLockinPeriodFrequencyType( enumOptionDataToEnumOptionDataV1( source.getLockinPeriodFrequencyType() ) );
        recurringDepositAccountDataV1.setWithdrawalFeeForTransfers( source.isWithdrawalFeeForTransfers() );
        recurringDepositAccountDataV1.setDepositType( enumOptionDataToEnumOptionDataV1( source.getDepositType() ) );
        recurringDepositAccountDataV1.setMinBalanceForInterestCalculation( source.getMinBalanceForInterestCalculation() );
        recurringDepositAccountDataV1.setWithHoldTax( source.isWithHoldTax() );
        recurringDepositAccountDataV1.setSummary( savingsAccountSummaryDataToSavingsAccountSummaryDataV1( source.getSummary() ) );
        recurringDepositAccountDataV1.setTransactions( savingsAccountTransactionDataCollectionToSavingsAccountTransactionDataV1List( source.getTransactions() ) );
        recurringDepositAccountDataV1.setCharges( savingsAccountChargeDataCollectionToSavingsAccountChargeDataV1List( source.getCharges() ) );
        recurringDepositAccountDataV1.setPreClosurePenalApplicable( source.isPreClosurePenalApplicable() );
        recurringDepositAccountDataV1.setPreClosurePenalInterest( source.getPreClosurePenalInterest() );
        recurringDepositAccountDataV1.setPreClosurePenalInterestOnType( enumOptionDataToEnumOptionDataV1( source.getPreClosurePenalInterestOnType() ) );
        recurringDepositAccountDataV1.setMinDepositTerm( source.getMinDepositTerm() );
        recurringDepositAccountDataV1.setMaxDepositTerm( source.getMaxDepositTerm() );
        recurringDepositAccountDataV1.setMinDepositTermType( enumOptionDataToEnumOptionDataV1( source.getMinDepositTermType() ) );
        recurringDepositAccountDataV1.setMaxDepositTermType( enumOptionDataToEnumOptionDataV1( source.getMaxDepositTermType() ) );
        recurringDepositAccountDataV1.setInMultiplesOfDepositTerm( source.getInMultiplesOfDepositTerm() );
        recurringDepositAccountDataV1.setInMultiplesOfDepositTermType( enumOptionDataToEnumOptionDataV1( source.getInMultiplesOfDepositTermType() ) );
        if ( source.getDepositAmount() != null ) {
            recurringDepositAccountDataV1.setDepositAmount( source.getDepositAmount().floatValue() );
        }
        if ( source.getMaturityAmount() != null ) {
            recurringDepositAccountDataV1.setMaturityAmount( source.getMaturityAmount().floatValue() );
        }
        recurringDepositAccountDataV1.setMaturityDate( avroDateTimeMapper.mapLocalDate( source.getMaturityDate() ) );
        recurringDepositAccountDataV1.setDepositPeriod( source.getDepositPeriod() );
        recurringDepositAccountDataV1.setDepositPeriodFrequency( enumOptionDataToEnumOptionDataV1( source.getDepositPeriodFrequency() ) );
        recurringDepositAccountDataV1.setMandatoryRecommendedDepositAmount( source.getMandatoryRecommendedDepositAmount() );
        recurringDepositAccountDataV1.setTotalOverdueAmount( source.getTotalOverdueAmount() );
        recurringDepositAccountDataV1.setNoOfOverdueInstallments( source.getNoOfOverdueInstallments() );
        recurringDepositAccountDataV1.setIsMandatoryDeposit( source.isIsMandatoryDeposit() );
        recurringDepositAccountDataV1.setAllowWithdrawal( source.isAllowWithdrawal() );
        recurringDepositAccountDataV1.setAdjustAdvanceTowardsFuturePayments( source.isAdjustAdvanceTowardsFuturePayments() );
        recurringDepositAccountDataV1.setExpectedFirstDepositOnDate( avroDateTimeMapper.mapLocalDate( source.getExpectedFirstDepositOnDate() ) );
        recurringDepositAccountDataV1.setIsCalendarInherited( source.isIsCalendarInherited() );
        recurringDepositAccountDataV1.setRecurringFrequency( source.getRecurringFrequency() );
        recurringDepositAccountDataV1.setRecurringFrequencyType( enumOptionDataToEnumOptionDataV1( source.getRecurringFrequencyType() ) );

        return recurringDepositAccountDataV1;
    }
