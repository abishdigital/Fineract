...
public class LoanProduct extends AbstractPersistableCustom {
	...
	//    Written by Iwin
	@Column(name = "loanPeriodFrequency")
	private Integer loanPeriodFrequency;
	
	//  Written by Iwin
	@Column(name = "loanPeriodFrequencyType")
	private Integer loanPeriodFrequencyType;
	  
	//Written by Iwin
	@Column(name = "isIwinLoanProduct")
	private String isIwinLoanProduct;
	  
	//Written by Iwin
	@Column(name = "forAmount")
